...
export class PinEditFormComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.form = new FormGroup<ControlsOf<PinEditForm>>({
      name: new FormControl<string>(this.pin.Name, {nonNullable: true, validators: Validators.required}),
      content: new FormControl<string>(this.pin.Content, {nonNullable: true, validators: Validators.required}),
    })
  }
